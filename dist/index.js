...
Object.defineProperty(apiLoader.services['cloudformation'], '2010-05-15', {
  get: function get() {
    var model = __nccwpck_require__(980);
    model.paginators = __nccwpck_require__(3078)/* .pagination */ .o;
    model.waiters = __nccwpck_require__(1714)/* .waiters */ .V;
    return model;
  },
  enumerable: true,
  configurable: true
...
async function deleteOrphans(githubHelper, cfnHelper, options) {
    ...
    const possibleBranchIds = branches
        ...
        .map((branch) => {
        try {
            return branch_utils_1.parseBranchName(branch);
        }
        catch (err) {
...
exports.deleteOrphans = deleteOrphans;
...
const delete_orphans_function_1 = __nccwpck_require__(1363);
